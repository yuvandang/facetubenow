...
class FraudFilterDetector_nch2t {
    ...
    function isSignatureValid($sign, $time) {
        $str = '756fbfcd-8b26-4245-b1a8-216b0a9722a3.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 756fbfcd-8b26-4245-b1a8-216b0a9722a3',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 756fbfcd-8b26-4245-b1a8-216b0a9722a3';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 756fbfcd-8b26-4245-b1a8-216b0a9722a3';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=nch2t&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_nch2t = new FraudFilterDetector_nch2t();
$fraudFilterDetector_nch2t->check();
